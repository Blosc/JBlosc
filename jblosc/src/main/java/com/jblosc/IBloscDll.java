...
public interface IBloscDll extends Library {
	...
	int blosc_compress(int clevel, int doshuffle, NativeLong typesize, NativeLong nbytes, Pointer src, Pointer dest,
			NativeLong destsize);

	int blosc_compress_ctx(int clevel, int doshuffle, NativeLong typesize, NativeLong nbytes, Pointer src, Pointer dest,
			NativeLong destsize, String compressor, NativeLong blocksize, int numinternalthreads);
	...
	void blosc_cbuffer_sizes(Pointer cbuffer, NativeLongByReference nbytes, NativeLongByReference cbytes,
			NativeLongByReference blocksize);
